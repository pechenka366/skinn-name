...
import ProductsListItem from '@/components/modules/ProductListItem/ProductsListItem'
...
const ProductsPage = ({ searchParams, pageName }: IProductsPage) => {
  ...
  const handleApplyFiltersWithColors = (colors: string[]) => {
    // Логика для обработки фильтрации по цветам
    console.log('Applying filters with colors:', colors)
  }

  const handleApplyFiltersBySort = (sortOption: string) => {
    // Логика для обработки сортировки
    console.log('Applying filters by sort:', sortOption)
  }
